...
```{r echo=FALSE}
knitr::kable(cambios, caption="La tabla del Mario Amor")
```
...
En este sentido, con datos de INEGI y siguiendo la metodología propuesta por Wassily Leontief se construyó una Matríz de Insumo-Producto para México. En apartados precedentes se señaló que esta herramienta permite representar y estudiar las interrelaciones entre los sectores productivos de una economía. 
Como resultado se obtuvo la tabla 1, en ella se observan todas las actividades económicas, de acuerdo con la clasificación de INEGI, acompañadas de tres posibles escenarios en caso de que las exportaciones se enfrenten a un arancel generalizado de 10% (escenario 1), de 25% (escenario 2)
y de 30% (escenario 3). En primera instancia, si los aranceles se incrementan en 10% las exportaciones mexicanas caerían en promedio -2.5%, siendo la agricultura, cría y explotación de animales, la minería y la industria manufacturera con una contracción del -4.59%, 6.38% y 5.13% respectivamente. Al revisar el efecto promedio en este primer escenario la caída de las exportaciones sería del -2.5%.
Por su parte, si el incremento de los aranceles es del 25% las exportaciones disminuirían en -6.2%,  en promedio. En este escenario el efecto es mayor, para la agricultura, cría y explotació de animales, la minería y la industria manufacturera el impacto sería de dos digitos; -11.5%, -16% y -12.8% respectivamente. Por otro lado, se observan más actividades afectadas en este escenario, por ejemplo, 
las exportaciones de generación, distribución y comercialización "" caería en -5.4%, el comercio al por mayor y al por menor lo haría en -6.5%. Por último, si los aranceles se imponen por 30% el efecto en las exportaciones se agudiza. Las exportaciones de la agricultura, cría y explotación de animales, la minería y la industria manufacturera
sufrirían un contracción del -13.8%, -19.1% y -15.4% respectivamente.
