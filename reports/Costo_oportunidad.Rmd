...
El analisis muestra que a medida que se incrementan los aranceles (del 10% al 25%), los impactos negativos se amplifican y se extienden en el resto de la economia nacional.
Estos incrementos impactan de manera especial a sectores altamente integrados a la economía internacional, como la industria manufacturera, la agricultura y ganadería y el transporte.
...
En lugar de una integración basada en la reciprocidad, México ha forjado una relación comercial asimétrica, donde exporta grandes volumenes pero con poco valor agregado, y con bajo poder de negociación.

Si bien es cierto que el modelo de crecimiento hacia afuera permitió insertar a México en el comercio internacional y atraer inversión extranjera, se hizo a costa de debilitar la producción nacional,
desmantelar las políticas de fomento al sector primario y marginar a muchas pequeñas y medianas empresas del proceso de globalización.
En lugar de aprovechar las cadenas de valor para generar capacidades productivas internas, el país se volvió un proveedor de bienes intermedios y materias primas, que, en muchos de los casos, ni siquiera pasan por procesos de transformación local.
...
En consecuencia, es necesario abrir un debate sobre la redifinición de la estrategía de desarrollo productivo de México, una en donde no sólo se priorice la exportación, sino que también fortalezca el mercado interno.
